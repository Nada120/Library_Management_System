...
public class LoginLibrarian extends JFrame {
	...
	public LoginLibrarian() {
		...
		btnCreate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				NewLibrarianAccount b = new NewLibrarianAccount();
		...
		jButton1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(l.username.isEmpty() || l.password.isEmpty()) {
					JOptionPane.showMessageDialog(null, "Username and Password can not be Empty");
				}
				else if(la.IsPasswordUsernameExisting(l.username, l.password)) {
					dispose();
		...
		panel_1.setBounds(0, 91, 271, 176);
		...
		lblNewLabel.setBounds(0, 0, 271, 176);
